#!/usr/bin/env python3
"""
Script para corregir el endpoint from-carta usando consultas SQL directas
"""
import sys
import os
sys.path.append(os.path.dirname(os.path.abspath(__file__)))

# Leer el archivo del router actual
...
print("✅ Endpoint corregido exitosamente!")
print("   El endpoint from-carta ahora usa consultas SQL directas.")
